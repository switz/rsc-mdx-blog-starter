...
You can view this starter kit (static hosted on Cloudflare pages) at: https://rsc-mdx-blog.saewitz.com
...
Though this is a static export – you can easily convert this to a request-response model with a server (backed by a Dockerfile or deployed to serverless platforms like Vercel or Cloudflare Workers).

In static mode: Timber automatically pre-renders React flight payloads for every page so client side routing works natively even in static export.
